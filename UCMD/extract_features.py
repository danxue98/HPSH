...
def main_graph(self):
    ...
    with open('features_UCMD.pkl', 'wb') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model_dir',
        type=str,
        default='/media/nvidia/0000678400004823/dx0/MHCLN-master0/tflib',
        #required=True,
        help="""\
            ...
            """
        #help='/home/MHCLN-master/tflib/classify_image_graph_def.pd'
    )
    parser.add_argument(
        '--images_dir',
        type=str,
        default='/media/nvidia/0000678400004823/dx0/MHCLN-master0/UCMD_LU/Images',
        #required=True,
        help="""\
            Specify the absolute path of the data set\
        """
        #help='images_dir=/home/MHCLN-master/UCMD_LU'
    )
    parser.add_argument(
        '--dump_dir',
        type=str,
        default='dump_dir/MHCLN',
        help="""\
                The directory to store temporary files\
            """
        #help='/home/MHCLN-master/UCMD/temporaryFiles'
    )
